...
export default function Home() {
  ...
  return (
      ...
      <div className="container mx-auto px-4 py-8 text-center z-10">
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-6">A Creative Frontend Developer</p>
        <p className="max-w-2xl mx-auto text-gray-400 mb-10">
          I build beautiful and responsive web applications. Passionate about creating intuitive user experiences and working with modern web technologies.
        </p>

        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <Link to="/projects" className="group relative inline-flex items-center justify-center w-full sm:w-auto px-8 py-3 text-white font-semibold bg-gray-800 rounded-lg overflow-hidden transition-all duration-300 hover:bg-gray-900 shadow-lg hover:shadow-blue-500/30"  >
            ...
            <span className="relative flex items-center gap-2"> My Work <FaArrowRight />
            </span>
          </Link>
